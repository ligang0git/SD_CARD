...
#endif
static FATFS *FatFs[_VOLUMES];	/* Pointer to the file system objects (logical drives) *///定义一个文件系统对象指针数组，当然一般我们 就用到一个元素
...
static WCHAR LfnBuf[_MAX_LFN + 1];//这个与长文件名支持相关的
#define	DEFINE_NAMEBUF		BYTE sfn[12]
